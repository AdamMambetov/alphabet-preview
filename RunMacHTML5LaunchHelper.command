...
EPIC_MONO=""
if [ -f "A:\UnrealEngine\Binaries\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "A:\UnrealEngine\Binaries\UE_4.23\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'A:\UnrealEngine\Binaries\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
